...
export const TEXTS = {
    ru: {
        ...
        endless:'Бесконечная Гонка', chase:'Уход от погони', duel:'Гонка Дуэль', fuel:'Топливный рейс',
        endlessDesc:'Собери все монеты', chaseDesc:'Оторвись от полиции',
        duelDesc:'Кто быстрее к финишу', fuelDesc:'Следи за индикатором',
        ...
        cop:'Перехват', copDesc:'Догони преступника', ambulanceMode:'Спец-Вызов', ambulanceDesc:'Спасение жизней',
        taxi:'Шашки по городу', taxiDesc:'Такси-Дрифт', timeUp:'ВРЕМЯ ВЫШЛО!',
